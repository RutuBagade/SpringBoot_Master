...
public class EmployeeExcelExporter {
    ...
    private void writeHeaderLine() {
        sheet = workbook.createSheet("EmployeeList");
        ...
        createCell(row, 2, "Employee AGE", style);    
        createCell(row, 3, "Employee DEPARTMENT", style);
    ...
    private void writeDataLines() {
        ...
        for (Employee emp : listemployee) {
            ...
            createCell(row, columnCount++, emp.getDept().toString(), style);
